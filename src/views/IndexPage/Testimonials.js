  ...
  var settings = {
    ...
    return (
      <div className="my-5 testimonial">
        ...
        <div className="container-fluid pb-5" style={{ backgroundColor: "#bbbbbb" }}>
          <Slider {...settings}>
            <div className="row py-4">
              ...
              <div
                className="col-sm w-50 shadow bg-white m-auto t-card"
              >
                ...
                <div className="row mx-3 t-card-footer">
